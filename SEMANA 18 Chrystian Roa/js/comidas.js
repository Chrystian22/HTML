function mostrar()
      {
        ...
        if(item3.selectedIndex==0)
           ...
           {
            document.getElementById('adic0').value=3000;//Valor cerveza
           }
           else if(document.getElementById('radio5').checked)
              {
                document.getElementById('adic0').value=2500;//Valor helado
              }
              else if (document.getElementById('radio6').checked)
                  {
                    document.getElementById('adic0').value=2300;//Valor jugo
                  }
